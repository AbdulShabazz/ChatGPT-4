    ...
    */
    ...
    while (!Tasks_Thread.empty() && !QED)
    {
        ...
        if (TentativeProofFound_Flag)
        {
            ...
            // now we need to verify the solution actually converges onto a valid routemap...
            
            /** 
             * opcode field: [opcode:00|01|02|03][Axiom_ID:N], where opcode may be
             * 
             * 00: _lhs _reduce
             * 01: _lhs _expand
             * 02: _rhs _reduce
          ...
          ++TotalProofsFound_UInt64;
            ...
            for (const std::vector<uint64_t>& Axiom : Axioms_UInt64Vec)
            {
				if (Theorem[LHS] % Axiom[LHS] == 0/* && !CallHistory_00[Theorem[LHS]][Axiom[LHS]]*/ )
				{
					...
					Theorem_0000.emplace_back ( 0x00 ); // Push opcode 00 (perform _lhs _reduce operation) onto the proofstack //
					...
					std::cout << "_reduce Module_0000 {" << Theorem_0000[LHS] << ", " << Theorem_0000[RHS] << "}" << std::endl;
				...
				if (Theorem[LHS] % Axiom[RHS] == 0/* && !CallHistory_01[Theorem[LHS]][Axiom[RHS]]*/ )
				{
					...
					Theorem_0001.emplace_back ( 0x01 ); // Push opcode 01 (perform _lhs _expand operation) onto the proofstack //
					...
					std::cout << "_expand Module_0001 {" << Theorem_0001[LHS] << ", " << Theorem_0001[RHS] << "}" << std::endl;
				...
				if (Theorem[RHS] % Axiom[LHS] == 0 /*&& !CallHistory_02[Theorem[RHS]][Axiom[LHS]]*/ )
				{
					...
					Theorem_0002.emplace_back ( 0x02 ); // Push opcode 02 (perform _rhs _reduce operation) onto the proofstack //
					...
					std::cout << "_reduce Module_0002 {" << Theorem_0002[LHS] << ", " << Theorem_0002[RHS] << "}" << std::endl;
				...
				if (Theorem[RHS] % Axiom[RHS] == 0 /*&& !CallHistory_03[Theorem[RHS]][Axiom[RHS]] */)
				{
					...
					Theorem_0003.emplace_back ( 0x03 ); // Push opcode 03 (perform _rhs _expand operation) onto the proofstack //
					...
					std::cout << "_expand Module_0003 {" << Theorem_0003[LHS] << ", " << Theorem_0003[RHS] << "}" << std::endl;
