	...
	*/
    ...
    auto processAxioms = [&]() noexcept -> void
    {
        ...
        for(std::vector<uint64_t>& Axiom_i : Axioms_UInt64Vec) 
        {
            ...
            std::unordered_map<uint64_t, bool> _cg3;
            std::unordered_map<uint64_t, bool> _cg4;
            
            LHSExpandCallGraph_UInt64Map.insert(std::make_pair(i, _cg1));
            LHSReduceCallGraph_UInt64Map.insert(std::make_pair(i, _cg2));
            RHSExpandCallGraph_UInt64Map.insert(std::make_pair(i, _cg3));
            RHSReduceCallGraph_UInt64Map.insert(std::make_pair(i, _cg4));
