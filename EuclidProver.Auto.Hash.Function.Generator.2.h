...
int main ()
{
    std::array<std::string,2> l1 = { "NoProofFound_Flag", "ProofFound_Flag" };
    std::array<std::string,2> l2 = { "NoMaxProofsFound_Flag", "MaxProofsFound_Flag" };
    std::array<std::string,2> l2a = { "NoLHSSubnetFound", "LHSSubnetFound" };
    std::array<std::string,2> l2b = { "NoRHSSubnetFound", "RHSSubnetFound" };
  ...
  ++InTheorem.TotalProofsFound_UInt64;\n\
    ...
    const std::string buff4 = "\
            ...
            {\n\
                ...
                [\n\
                    Axiom.RHSCallGraph_UInt64Map.find(RouteSource_EnumClass::_lhs) != Axiom.RHSCallGraph_UInt64Map.begin() && \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_lhs].find(TheoremProto_0000.guid) != \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_lhs].begin() \n\
                ]\n\
    ...
    \n\
                ...
                [TheoremProto_0000.TotalProofsFound_UInt64 >= TheoremProto_0000.MaxAllowedProofs_UInt64]\n\
                [\n\
                    Axiom.RHSCallGraph_UInt64Map.find(RouteSource_EnumClass::_rhs) != Axiom.RHSCallGraph_UInt64Map.begin() && \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_rhs].find(TheoremProto_0000.guid) != \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_rhs].begin() \n\
                ]\n\
                ...
                [\n\
                    Axiom.RHSCallGraph_UInt64Map.find(RouteSource_EnumClass::_lhs) != Axiom.RHSCallGraph_UInt64Map.begin() && \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_lhs].find(TheoremProt_0001.guid) != \n\
                    Axiom.RHSCallGraph_UInt64Map[RouteSource_EnumClass::_lhs].begin() \n\
                ]\n\
                [RouteSource_EnumClass::_lhs]\n\
                [Indirection_EnumClass::_reduce]\n\
   ...
   const std::string buff6 = "\
    ...
    for(const std::string& ProofFound_Str : l1)
    {
        for(const std::string& TotalProofsFound_Str : l2)
        {
            for(const std::string& LHSSubnet_Str : l2a)
            {
                for(const std::string& RHSSubnet_Str : l2b)
                {
